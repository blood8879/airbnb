...
const RegisterRoomBedTypes: React.FC<IProps> = ({ bedroom }) => {
    ...
    // 선택된 침대 옵션들
    const [activateBedOptions, setActiveBedOptions] = useState<BedType[]>(initialBedOptions);
    ...
    const lastBedOptions = useMemo(() => {
        return bedTypes.filter((bedType) => !activateBedOptions.includes(bedType));
    }, [activateBedOptions, bedroom]);
